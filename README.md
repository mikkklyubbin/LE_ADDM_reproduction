...
Результаты обучения представлены в отчете https://www.comet.com/no-i/le-addm-reproduction/reports/fAAgkqHfzwBMGWd0ayY8CFebk
...
Загрузка весов моделей осуществляется при помощи скрипта `./src/utils/model_downloads.py`
